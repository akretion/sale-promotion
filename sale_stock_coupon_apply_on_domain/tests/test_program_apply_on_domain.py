...
from odoo.addons.sale_stock_coupon.tests.common import TestSaleStockCouponCommon


@tagged("post_install", "-at_install")
class TestSaleStockCouponApplyOnDomain(TestSaleStockCouponCommon):
    def setUp(self):
        super(TestSaleStockCouponApplyOnDomain, self).setUp()
    ...
    def test_sale_stock_coupon_invoicing_partial_delivery_product_domain(self):
